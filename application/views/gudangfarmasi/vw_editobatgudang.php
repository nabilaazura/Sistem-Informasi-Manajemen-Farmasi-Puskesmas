                ...
                <div class="card-body p-3">
                    <form action="<?= base_url('GudangFarmasi/update'); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="kode_obat" value="<?= $obat['kode_obat']; ?>" class="form-control" type="text" placeholder="Kode Obat" id="example-text-input" required>
                        </div>
                        <div class="form-group">
                            <label for="nama_obat" class="form-control-label">Nama Obat</label>
                            <input name="nama_obat" value="<?= $obat['nama_obat']; ?>" class="form-control" type="text" placeholder="Nama Obat" id="example-text-input" required>
                        </div>
                        <div class="form-group">
                            <label for="satuan" class="form-control-label">Satuan/Kemasan</label>
                            <input name="satuan" value="<?= $obat['satuan']; ?>" class="form-control" type="text" placeholder="Satuan/Kemasan" id="example-text-input" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="jumlah_masuk" value="<?= $obat['jumlah_masuk']; ?>" class="form-control" type="number" placeholder="Jumlah Masuk" id="example-text-input" required>
                        </div>
                        <div class="form-group">
                            <label for="pengadaan" class="form-control-label">Kategori Pengadaan</label>
                            <select name="pengadaan" value="<?= $obat['pengadaan']; ?>" class="form-control" id="exampleFormControlSelect1" placeholder="Kategori Pengadaan" required>
                        ...
                        <div class="form-group">
                            ...
                            <input name="expire" value="<?= $obat['expire']; ?>" class="form-control" type="date" id="example-date-input" required>
                        </div>
