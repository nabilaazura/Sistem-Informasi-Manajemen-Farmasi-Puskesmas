<div class="container-fluid py-4">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 d-flex">
            <a href="<?= base_url(); ?>GudangFarmasi/tambahObat" class="btn bg-gradient-default float-right" style="background-color: white;">Tambah Obat</a>
        </div>
    </div>
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Data Obat Gudang Farmasi</h6>
            </div>
