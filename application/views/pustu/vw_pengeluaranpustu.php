                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="nama_obat" id="autocomplete2" class="form-control" placeholder="Cari Obat" type="text" aria-describedby="stok" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_pengeluaran" class="form-control" id="status_pengeluaran">
                                    <option value="permintaan_pustu">Permintaan Pustu</option>
                            ...
                            <div class="col-sm-2 float-end">
                                <a href="<?= base_url('Pustu/getPengeluaranPustu') ?>" class="btn btn-outline-danger" style="background-color: white;">Batal</a>&nbsp;&nbsp;
