        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <a href="<?= base_url(); ?>Pustu/getPengeluaranPustu" type="button" class="btn btn-outline-primary float-end" ps-3>Formulir Pengeluaran Obat</a>
                    <h6>Riwayat Pengeluaran Obat Pustu</h6>
                </div>
