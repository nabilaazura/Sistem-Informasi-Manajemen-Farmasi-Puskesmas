        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Daftar Obat Keluar Apotek</h6>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-3">
                        <table id="datatable" class="table align-items-center mb-0 stripe" style="width:100%">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                <?php foreach ($data_obat_keluar as $pengeluaran_apotek) : ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0"><?= $pengeluaran_apotek['kode_obat']; ?></p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0"><?= $pengeluaran_apotek['nama_obat']; ?></p>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0"><?= $pengeluaran_apotek['jumlah']; ?></p>
                                        </td>
