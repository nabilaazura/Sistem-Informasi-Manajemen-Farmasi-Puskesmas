                ...
                <div class="card-body p-3">
                    <form action="<?= base_url('Apotek/update'); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="kode_obat" value="<?= $obat_apotek['kode_obat']; ?>" class="form-control" type="text" placeholder="Kode Obat" id="example-text-input">
                        </div>
                        <div class="form-group">
                            <label for="nama_obat" class="form-control-label">Nama Obat</label>
                            <input name="nama_obat" value="<?= $obat_apotek['nama_obat']; ?>" class="form-control" type="text" placeholder="Nama Obat" id="example-text-input">
                        </div>
                        <div class="form-group">
                            <label for="satuan" class="form-control-label">Satuan/Kemasan</label>
                            <input name="satuan" value="<?= $obat_apotek['satuan']; ?>" class="form-control" type="text" placeholder="Satuan/Kemasan" id="example-text-input">
                        </div>
                        <div class="form-group">
                            <label for="harga" class="form-control-label">Harga Satuan</label>
                            <input name="harga" value="<?= $obat_apotek['harga']; ?>" class="form-control" type="text" placeholder="Harga Satuan" id="example-text-input">
                        </div>
                        <div class="form-group">
                            <label for="stok" class="form-control-label">Stok</label>
                            <input name="stok" value="<?= $obat_apotek['stok']; ?>" class="form-control" type="text" placeholder="Stok" id="example-text-input">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="expire" value="<?= $obat_apotek['expire']; ?>" class="form-control" type="date" id="example-date-input">
                        </div>
