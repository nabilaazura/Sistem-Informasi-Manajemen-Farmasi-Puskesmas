                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_pengeluaran" class="form-control" id="status_pengeluaran">
                                    <option value="permintaan_apotek" selected>Permintaan Apotek</option>
                            ...
                            <div class="col-sm-2 float-end">
                                <a href="<?= base_url('Apotek/getPengeluaranApotek') ?>" class="btn btn-outline-danger" style="background-color: white;">Batal</a>&nbsp;&nbsp;
