        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <a href="<?= base_url(); ?>Apotek/getPengeluaranApotek" type="button" class="btn btn-outline-primary float-end" ps-3>Formulir Pengeluaran Obat</a>
                    <h6>Riwayat Pengeluaran Obat Apotek</h6>
                </div>
