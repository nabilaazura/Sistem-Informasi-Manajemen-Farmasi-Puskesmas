      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <a href="<?= base_url(); ?>Poned/getPemasukanPoned" type="button" class="btn btn-outline-primary float-end" ps-3>Tambah Pemasukan Obat</a>
            <h6>Daftar Obat Poned</h6>
          </div>
                  ...
                  <?php foreach ($data_obat as $obat_poned) : ?>
                    <tr>
                      ...
                      <td class="align-middle text-sm">
                        <a class="badge badge-sm bg-primary" data-bs-toggle="modal" data-bs-target="#exampleModalMessage<?= $obat_poned['id_obat']; ?>">Tambah Stok</a> &nbsp;
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModalMessage<?= $obat_poned['id_obat']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalMessageTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?= base_url('Poned/updateStok'); ?>" method="post">
                              <input type="hidden" name="id_obat" value="<?= $obat_poned['id_obat']; ?>" />
                              <input type="hidden" name="jumlah_lama" value="<?= $obat_poned['jumlah_masuk']; ?>" />
