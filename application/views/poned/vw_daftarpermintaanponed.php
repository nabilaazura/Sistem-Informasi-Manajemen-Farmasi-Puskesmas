        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <a href="<?= base_url(); ?>Poned/getPermintaanPoned" type="button" class="btn btn-outline-primary float-end" ps-3>Formulir Permintaan Obat</a>
                    <h6>Riwayat Permintaan Obat Poned</h6>
                </div>
