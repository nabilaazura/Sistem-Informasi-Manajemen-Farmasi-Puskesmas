  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Puskesmas Pembantu</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?php if ($menu == "dashboard") echo 'active' ?>" href="<?= base_url('Pustu'); ?>">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if ($menu == "obat") echo 'active' ?>" href="<?= base_url('Pustu/getObatPustu/'); ?>">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if ($menu == "laporan obat") echo 'active' ?>" href="<?= base_url('Pustu/laporanPustu/'); ?>">
